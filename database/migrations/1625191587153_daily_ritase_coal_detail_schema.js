...
class DailyRitaseCoalDetailSchema extends Schema {
  up () {
    this.create('daily_ritase_coal_details', (table) => {
      ...
      table.datetime('checkin_jt').defaultTo(null)
      table.datetime('checkout_jt').defaultTo(null)
      table.string('ticket', 20).defaultTo(null)
      table.string('kupon', 7).notNullable()
