...
$(function(){
    ...
    $('body').on('click', 'button.btn-view-data', function(e){
        ...
        $.ajax({
            async: true,
            url: '/logistik/purchasing-request/'+id+'/view',
            method: 'GET',
    ...
    $('body').on('click', 'button.btn-received-items', function(e){
        e.preventDefault()
        var id = $(this).data('id')
        $.ajax({
            async: true,
            url: '/logistik/purchasing-request/'+id+'/add-stock',
            method: 'GET',
            success: function(result){
                $('div#list-content').children().remove()
                $('div#form-content').html(result).show()
    ...
    $('body').on('submit', 'form#fm-purchasing-request', function(e){
        ...
        $.ajax({
            async: true,
            url: '/logistik/purchasing-request',
            method: 'POST',
            data: dataForm,
            dataType: 'json',
            processData: false,
    ...
    $('body').on('submit', 'form#fm-received-items', function(e){
        e.preventDefault()
        var id = $(this).data('id')
        const data = formJSON()
        const dataForm = new FormData()
    ...
    //     $.ajax({
    //         async: true,
    //         url: '/logistik/purchasing-request/'+id+'/update',
    //         method: 'POST',
    //         data: data,
    //         dataType: 'json',
    //         processData: false,
    ...
    function initDefault(){
        ...
        $.ajax({
            async: true,
            url: '/logistik/purchasing-request/list?limit=',
            method: 'GET',
            success: function(result){
    ...
    function initCreate(){
        $.ajax({
            async: true,
            url: '/logistik/purchasing-request/create',
            method: 'GET',
            success: function(result){
                $('div#list-content').children().remove()
                $('div#form-content').html(result).show()
    ...
    function initShow(id){
        $.ajax({
            async: true,
            url: '/logistik/purchasing-request/'+id+'/show',
            method: 'GET',
            success: function(result){
                $('div#list-content').children().remove()
                $('div#form-content').html(result).show()
    ...
    function addRowItems(){
        $.ajax({
            async: true,
            url: '/logistik/purchasing-request/items-create',
            method: 'GET',
            success: function(result){
