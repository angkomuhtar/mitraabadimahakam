...
-- ----------------------------
BEGIN;
INSERT INTO `mas_employees` VALUES (1, 'MAM-032101001', 'Ayat Ekapoetra', 'JL. Pacalaya No.06 Kel. Tombolo, Kec. Somba Opu, Kab. Gowa', 'm', 'Makassar', '1980-12-08', 'islam', 'KTP', NULL, 'Indonesia', 168, 47, 'menikah', '01', 'permanent', '2021-03-21', '123123123123', '081355719747', 2, 'Y', '2021-04-17 10:50:22', '2021-04-17 10:50:22');
INSERT INTO `mas_employees` VALUES (3, 'MAM0121040002', 'Alfatih Kenzie Poetra', 'JL. Hertasning 7 No.22c', 'm', 'Makassar', '2014-02-25', 'islam', 'KTP', '123123123123', 'Indonesia', 175, 80, 'singel', '01', 'permanent', '2021-04-01', '08123456789', 'kensie@poetra.co', 2, 'Y', '2021-04-17 11:04:17', '2021-04-17 11:04:17');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `profiles` VALUES (1, 2, 'Ayat', 'Ekapoetra', '081355719747', 'm', NULL, '2021-04-15 15:10:00', '2021-04-15 15:10:03');
COMMIT;
...
INSERT INTO `sys_menu_details` VALUES (4, 1, 'Equipment', 'mas.equipment.index', 'ti-truck', 4, 'Y', '2021-03-18 13:36:16', '2021-04-13 10:30:12');
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_modules` VALUES (1, 'sys-options', 'read module options', 'R', '2021-03-30 09:38:33', '2021-03-30 09:38:36');
INSERT INTO `sys_modules` VALUES (2, 'sys-options', 'create module options', 'C', '2021-03-30 09:38:33', '2021-03-30 09:38:36');
...
INSERT INTO `sys_options` VALUES (32, 'agama', 'Lainnya', 'lainnya', 6, 'Y', '2021-03-31 08:28:17', '2021-03-31 08:28:17');
...
CREATE TABLE `sys_users_groups` (
  ...
  KEY `mod_id` (`mod_id`),
  CONSTRAINT `sys_users_groups_group_id_foreign` FOREIGN KEY (`group_id`) REFERENCES `users_groups` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  CONSTRAINT `sys_users_groups_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_users_groups` VALUES (1, 2, NULL, 1, 'administrator');
INSERT INTO `sys_users_groups` VALUES (2, 2, 2, 4, 'administrator');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `tokens` VALUES (3, 2, '38e1f3c2-6f3e-4fe3-b2d4-620d39658eb4', 'remember_token', 0, '2021-04-16 08:59:36', '2021-04-16 08:59:36');
INSERT INTO `tokens` VALUES (4, 2, '9be7c806-912a-44a1-8abe-4a5852e80a81', 'remember_token', 0, '2021-04-17 08:02:43', '2021-04-17 08:02:43');
COMMIT;
